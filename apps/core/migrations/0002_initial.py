...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='usuarios',
            name='id_empresa',
            field=models.ForeignKey(db_column='id_empresa', on_delete=django.db.models.deletion.CASCADE, related_name='usuarios_empresa', to='core.empresa', verbose_name='Empresa'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, db_column='id_sucursal_predeterminada', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='usuarios_sucursal', to='core.sucursal', verbose_name='Sucursal Predeterminada'),
        ),
        migrations.AddField(
